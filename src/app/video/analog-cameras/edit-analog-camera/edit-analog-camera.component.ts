...
@Component({
  ...
  templateUrl: './edit-analog-camera.component.html',
  styleUrls: ['./edit-analog-camera.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class EditAnalogCameraComponent implements OnInit {
  ...
  */
  updateAnalogCamera(){
    ...
    this.analogCamera.accessories = new Array();
  ...
  fillList(data){
    data.forEach(element => {
      ...
      if(this.analogCamera.accessories.some(e => e.id === accessory.id)){
